...
BUG: When the an empty input is saved, properties cannot be read in App.jsx
Counter in javascript to get current stats
Sort dates
*/
const tableIcons = {
...
//is set into state 
  ...
  render(){
    return (
      ...
      <TextField variant = "outlined" value ={this.state.title} onChange = {this.Search} label ="Club Name"/>
      </div>
      <MaterialTable
